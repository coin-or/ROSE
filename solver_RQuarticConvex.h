/*
** Name:       solver_RQuarticConvex.h
** Author:     Leo Liberti & Sonia Cafieri
** Source:     GNU C++
** Purpose:    solver RQuarticConvex header
** License:    (C) Leo Liberti, all rights reserved. Code published under the 
               Common Public License.
** History:    080526 work started
*/

#ifndef _ROSESOLVERRQuarticConvexH
#define _ROSESOLVERRQuarticConvexH

#include "solver.h"

#define ROSEINFINITY 1e30

class RQuarticConvexSolver : public virtual Solver {

 public:
  RQuarticConvexSolver();
  ~RQuarticConvexSolver();
 ...
 private:
  ...
  // type of quartic convex relaxation (in {0,..,3}) 
  int QuarticConvexType;
};
