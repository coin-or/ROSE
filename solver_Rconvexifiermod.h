/*
** Name:       solver_Rconvexifiermod.h
** Author:     Leo Liberti & Sonia Cafieri
** Source:     GNU C++
** Purpose:    solver Rconvexifiermod header
** License:    (C) Leo Liberti, all rights reserved. Code published under the 
               Common Public License.
** History:    080606 work started
*/

#ifndef _ROSESOLVERRCONVEXIFIERMODH
#define _ROSESOLVERRCONVEXIFIERMODH

#include "solver.h"

#define ROSEINFINITY 1e30

class RconvexifiermodSolver : public virtual Solver {

 public:
  RconvexifiermodSolver();
  ~RconvexifiermodSolver();
 ...
 private:
  // print variables with correct AMPL name
  string VarIndexToString(int vi) const;
  string VarIndexToString(double cf, int vi) const;
  ...
  // original number of vars/constrs
  int nvar_orig;
  int nconstr_orig;
