...
** Author:     Leo Liberti
** Source:     GNU C++
** Purpose:    Copy reformulation / header file
** License:    (C) Leo Liberti, all rights reserved. Code published under the 
               Common Public License.
** History:    080229 work started
*/

#ifndef _ROSESOLVERCOPYH
#define _ROSESOLVERCOPYH

#include "solver.h"

#define ROSEINFINITY 1e30

class CopySolver : public virtual Solver {
 ...
 public:
  ...
  int GetNumberOfReformulations(void) const;
  Problem* GetReformulation(int ridx);
 ...
 private:
  ...
  // number of reformulated problems in output
  int NumberOfReformulations;

  // copy of input problem
  Problem* OutProb;
};
