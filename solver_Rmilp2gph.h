/*
** Name:       solver_Rmilp2gph.h
** Author:     Leo Liberti
** Source:     GNU C++
** Purpose:    solver Rmilp2gph header 
** License:    (C) Leo Liberti, all rights reserved. Code published under the 
               Common Public License.
** History:    111214 work started
*/

#ifndef _ROSESOLVERRMILP2GPHH
#define _ROSESOLVERRMILP2GPHH
...
class Rmilp2gphSolver : public virtual Solver {
