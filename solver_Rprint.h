/*
** Name:       solver_Rprint.h
** Author:     Leo Liberti 
** Source:     GNU C++
** Purpose:    identity reformulation, just print out problem
** License:    (C) Leo Liberti, all rights reserved. Code published under the 
               Common Public License.
** History:    080225 work started
*/

#ifndef _ROSESOLVERPRINTH
#define _ROSESOLVERPRINTH

#include "solver.h"

#define ROSEINFINITY 1e30

class PrintSolver : public virtual Solver {
