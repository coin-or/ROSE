/*
** Name:       solver_Rprintdat.h
** Author:     Leo Liberti & Sonia Cafieri
** Source:     GNU C++
** Purpose:    solver TEMPLATE header / change TEMPLATE w/ your solver name
** License:    (C) Leo Liberti, all rights reserved. Code published under the 
               Common Public License.
** History:    080917 work started
*/

#ifndef _ROSESOLVERTEMPLATEH
#define _ROSESOLVERTEMPLATEH

#include "solver.h"

#define ROSEINFINITY 1e30

class RprintdatSolver : public virtual Solver {
