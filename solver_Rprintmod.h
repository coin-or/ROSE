/*
** Name:       solver_Rprintmod.h
** Author:     Leo Liberti 
** Source:     GNU C++
** Purpose:    print out flat AMPL .mod file
** License:    (C) Leo Liberti, all rights reserved. Code published under the 
               Common Public License.
** History:    080225 work started
*/

#ifndef _ROSESOLVERPRINTMODH
#define _ROSESOLVERPRINTMODH

#include "solver.h"

#define ROSEINFINITY 1e30

class PrintmodSolver : public virtual Solver {
