/*
** Name:       solver_Rprintncvxdiscr.h
** Author:     Sonia Cafieri
** Source:     GNU C++
** Purpose:    solver Rprintncvxdiscr header
** License:    (C) Leo Liberti, all rights reserved. Code published under the 
               Common Public License.
** History:    090917 work started
*/

#ifndef _ROSESOLVERRprintncvxdiscrH
#define _ROSESOLVERRprintncvxdiscrH

#include "solver.h"

#define ROSEINFINITY 1e30

class RprintncvxdiscrSolver : public virtual Solver {

 public:
  RprintncvxdiscrSolver();
  ~RprintncvxdiscrSolver();
