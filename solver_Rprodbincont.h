/*
** Name:       solver_Rprodbincont.h
** Author:     Leo Liberti & Fabien Tarissan
** Source:     GNU C++
** Purpose:    ProdBinCont reformulation / header file
** License:    (C) Leo Liberti, all rights reserved. Code published under the 
               Common Public License.
** History:    071121 work started
*/

#ifndef _ROSESOLVERPRODBINCONTH
#define _ROSESOLVERPRODBINCONTH

#include "solver.h"

#define ROSEINFINITY 1e30

class ProdBinContSolver : public virtual Solver {
