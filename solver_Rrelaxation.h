/*
** Name:       solver_Rrelaxation.h
** Author:     Leo Liberti
** Source:     GNU C++
** Purpose:    solver Rrelaxation header
** License:    (C) Leo Liberti, all rights reserved. Code published under the 
               Common Public License.
** History:    081105 work started
*/

#ifndef _ROSESOLVERRrelaxationH
#define _ROSESOLVERRrelaxationH

#include "solver.h"

#define ROSEINFINITY 1e30

class RrelaxationSolver : public virtual Solver {
