/*
** Name:       solver_Rvinci.h
** Author:     Leo Liberti & Sonia Cafieri
** Source:     GNU C++
** Purpose:    solver Rvinci header
** License:    (C) Leo Liberti, all rights reserved. Code published under the 
               Common Public License.
** History:    080503 work started
*/

#ifndef _ROSESOLVERRvinciH
#define _ROSESOLVERRvinciH

#include "solver.h"

#define ROSEINFINITY 1e30

class RvinciSolver : public virtual Solver {
 ...
 private:
  ...
  // parameters for Rvinci reformulator
  ...
  int nb;    // counter of the finite bounds on variables;
