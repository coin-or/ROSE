/*
** Name:       solver_gomory.h
** Author:     Leo Liberti
** Source:     GNU C++
** Purpose:    solver gomory header 
** License:    (C) Leo Liberti, all rights reserved. Code published under the 
               Common Public License.
** History:    051003 work started (gomory cutting planes solver for MILPs)
*/

#ifndef _ROSESOLVERGOMORYH
#define _ROSESOLVERGOMORYH

#include "solver.h"

#define ROSEINFINITY 1e30

class GomorySolver : public virtual Solver {
