/*
** Name:       solver_Subgradient.h
** Author:     Lucas Letocart
** Source:     GNU C++
** Purpose:    solver Subgradient header
** License:    (C) Leo Liberti, all rights reserved. Code published under the 
               Common Public License.
** History:    081105 work started
*/

#ifndef _ROSESOLVERSubgradientH
#define _ROSESOLVERSubgradientH

#include "solver.h"

#define ROSEINFINITY 1e30

class SubgradientSolver : public virtual Solver {
